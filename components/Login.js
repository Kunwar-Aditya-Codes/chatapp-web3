...
const Login = () => {
  return (
    <div className="flex  items-center justify-center min-h-screen min-w-full bg-[#2F2F2F]">
      ...
      <div className="lg:flex-[0.6]  ">
        <div className="text-white lg:w-4/5 lg:mx-auto text-center p-5 space-y-6 shadow-md rounded-lg shadow-[#FFCB74]  ">
          <Image
          ...
          <button className="text-lg text-black font-bold  bg-[#FFCB74] py-3 px-5 rounded-md">
            Hop In
          </button>
        </div>
      </div>
